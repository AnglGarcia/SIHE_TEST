...
@Data
@Entity(name = "lenguaje_programacion")
@Table(name = "lenguaje_programacion")
public class LenguajeProgramacion {
	
	@Id
	@Column(name="id")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "leng_prog_seq")
	@SequenceGenerator(name = "leng_prog_seq", sequenceName = "leng_prog_seq", allocationSize = 1)
